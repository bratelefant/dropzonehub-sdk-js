...
<dl>
<dt><a href="#DropzoneClient">DropzoneClient</a></dt>
<dd></dd>
<dt><a href="#DropzoneClient">DropzoneClient</a></dt>
<dd></dd>
</dl>
...
| options | <code>Object</code> | Configuration options for the client. |
| [options.baseUrl] | <code>string</code> | The base URL for the API. |
| [options.apiKey] | <code>string</code> | The API key for authentication. Don't pass this to the constructor if you are on the client-side. |
| [options.dropzoneId] | <code>string</code> | Optional dropzone ID for operations that require it. |
